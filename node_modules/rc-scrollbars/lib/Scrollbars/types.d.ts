...
export declare type StyleKeys = 'containerStyleDefault' | 'containerStyleAutoHeight' | 'viewStyleDefault' | 'viewStyleAutoHeight' | 'viewStyleUniversalInitial' | 'trackHorizontalStyleDefault' | 'trackVerticalStyleDefault' | 'thumbStyleDefault' | 'disableSelectStyle' | 'disableSelectStyleReset';
