...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JSXGraph Reference - JXG.Math.Poly.Polynomial</title>
...
<p>
 <strong></strong><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#x21b3; <strong>JXG.Math.Poly.Polynomial</strong><br /><br /></p>
...
<!-- ============================== class summary ========================== -->
			<p class="description">
					...
					<br /><br /><i>Defined in: </i> <a href="../symbols/src/src_math_poly.js.html">poly.js</a>.
...
<!-- ============================== constructor summary ==================== -->			
			...
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class JXG.Math.Poly.Polynomial.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/JXG.Math.Poly.Polynomial.html#constructor">JXG.Math.Poly.Polynomial</a></b>(ring, str)
							</div>
							<div class="description">A polynomial is a sum of monomials.</div>
						</td>
					</tr>
				</tbody>
			</table>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class JXG.Math.Poly.Polynomial.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">JXG.Math.Poly.Polynomial.<b><a href="../symbols/JXG.Math.Poly.Polynomial.html#.add">add</a></b>(mp)
								</div>
								<div class="description">Adds another polynomial or monomial to this one and merges them by checking for the
signature of each new monomial in the existing monomials.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Math.Poly.Polynomial.<b><a href="../symbols/JXG.Math.Poly.Polynomial.html#.addSubMonomial">addSubMonomial</a></b>(m, factor)
								</div>
								<div class="description">Adds a monomial to the polynomial.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Math.Poly.Polynomial.<b><a href="../symbols/JXG.Math.Poly.Polynomial.html#.copy">copy</a></b>()
								</div>
								<div class="description">Creates a deep copy of the polynomial.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Math.Poly.Polynomial.<b><a href="../symbols/JXG.Math.Poly.Polynomial.html#.findSignature">findSignature</a></b>(sig)
								</div>
								<div class="description">Find a monomial with the given signature, i.e.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Math.Poly.Polynomial.<b><a href="../symbols/JXG.Math.Poly.Polynomial.html#.print">print</a></b>()
								</div>
								<div class="description">Prints the polynomial.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Math.Poly.Polynomial.<b><a href="../symbols/JXG.Math.Poly.Polynomial.html#.sub">sub</a></b>(mp)
								</div>
								<div class="description">Subtracts another polynomial or monomial from this one and merges them by checking for the
signature of each new monomial in the existing monomials.</div>
							</td>
						</tr>
...
<!-- ============================== constructor details ==================== -->
			...
			<div class="details"><a name="constructor"> </a>
				...
				<div class="fixedFont">
						<b>JXG.Math.Poly.Polynomial</b>(ring, str)
				</div>
					...
					A polynomial is a sum of monomials.
						...
						<dl class="detailList">
							...
							<dt>
    								...
    								<span class="light fixedFont">{<a href="../symbols/JXG.Math.Poly.Ring.html">JXG.Math.Poly.Ring</a>}</span>  <b>ring</b>
	    							
                                
                                
							</dt>
								<dd>A polynomial ring.</dd><br /><br />
							...
							<dt>
								...
								<dd>TODO String representation of the polynomial, will be parsed.</dd><br /><br />
...
<!-- ============================== method details ========================= -->		
				...
				<div class="sectionTitle">
					...
					<span class="light">JXG.Math.Poly.Polynomial.</span><b>add</b>(mp)
...
signature of each new monomial in the existing monomials.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{<a href="../symbols/JXG.Math.Poly.Polynomial.html">JXG.Math.Poly.Polynomial</a>|<a href="../symbols/JXG.Math.Poly.Monomial.html">JXG.Math.Poly.Monomial</a>}</span> <b>mp</b>
					...
					<a name=".addSubMonomial"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					
					<span class="light">JXG.Math.Poly.Polynomial.</span><b>addSubMonomial</b>(m, factor)
...
monomial's signature and just adds the coefficient if one is found.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{<a href="../symbols/JXG.Math.Poly.Monomial.html">JXG.Math.Poly.Monomial</a>}</span> <b>m</b>
								...
								<dd>Either <tt>1</tt> or <tt>-1</tt>.</dd>
					...
					<span class="light">{<a href="../symbols/JXG.Math.Poly.Polynomial.html">JXG.Math.Poly.Polynomial</a>}</span>
					<span class="light">JXG.Math.Poly.Polynomial.</span><b>copy</b>()
					...
					<div class="description">
						Creates a deep copy of the polynomial.
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{<a href="../symbols/JXG.Math.Poly.Polynomial.html">JXG.Math.Poly.Polynomial</a>}</span> </dd>
					...
					<a name=".findSignature"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					<span class="light">{Number}</span>
					<span class="light">JXG.Math.Poly.Polynomial.</span><b>findSignature</b>(sig)
					...
					<div class="description">
						Find a monomial with the given signature, i.e. exponent vector.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{Array}</span> <b>sig</b>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{Number}</span> The index of the first monomial with the given signature, or -1
if no monomial could be found.</dd>
					...
					<span class="light">JXG.Math.Poly.Polynomial.</span><b>print</b>()
					...
					<div class="description">
						Prints the polynomial.
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{String}</span> A string representation of the polynomial.</dd>
					...
					<span class="light">JXG.Math.Poly.Polynomial.</span><b>sub</b>(mp)
