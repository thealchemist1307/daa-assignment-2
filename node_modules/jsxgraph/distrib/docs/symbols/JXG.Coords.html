...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JSXGraph Reference - JXG.Coords</title>
...
<p>
 <strong></strong><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#x21b3; <strong>JXG.Coords</strong><br /><br /></p>
...
are defined here.
					...
					<br /><br /><i>Defined in: </i> <a href="../symbols/src/src_base_coords.js.html">coords.js</a>.
...
<!-- ============================== constructor summary ==================== -->			
			...
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class JXG.Coords.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/JXG.Coords.html#constructor">JXG.Coords</a></b>(method, coordinates, board, emitter)
							</div>
							<div class="description">Constructs a new Coordinates object.</div>
						</td>
					</tr>
				</tbody>
			</table>
...
<!-- ============================== properties summary ===================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the fields documented in the class JXG.Coords.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">
								<b><a href="../symbols/JXG.Coords.html#board">board</a></b>
								</div>
								<div class="description">Stores the board the object is used on.</div>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">
								<b><a href="../symbols/JXG.Coords.html#emitter">emitter</a></b>
								</div>
								<div class="description">If true, this coordinates object will emit update events every time
the coordinates are set.</div>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">
								<b><a href="../symbols/JXG.Coords.html#scrCoords">scrCoords</a></b>
								</div>
								<div class="description">Stores coordinates for screen view as homogeneous coordinates.</div>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">
								<b><a href="../symbols/JXG.Coords.html#usrCoords">usrCoords</a></b>
								</div>
								<div class="description">Stores coordinates for user view as homogeneous coordinates.</div>
							</td>
						</tr>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class JXG.Coords.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Coords.html#copy">copy</a></b>(obj, offset)
								</div>
								<div class="description">Copy array, either srcCoords or usrCoords
...
typed arrays.</div>
						...
						<tr>
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Coords.html#distance">distance</a></b>(coord_type, coordinates)
								</div>
								<div class="description">Calculate distance of one point to another.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;private&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Coords.html#normalizeUsrCoords">normalizeUsrCoords</a></b>()
								</div>
								<div class="description">Normalize homogeneous coordinates</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;private&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Coords.html#screen2usr">screen2usr</a></b>()
								</div>
								<div class="description">Compute user coordinates out of given screen coordinates.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Coords.html#setCoordinates">setCoordinates</a></b>(coord_type, coordinates, doRound, noevent)
								</div>
								<div class="description">Set coordinates by either user coordinates or screen coordinates and recalculate the other one.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;private&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Coords.html#usr2screen">usr2screen</a></b>(doRound)
								</div>
								<div class="description">Compute screen coordinates out of given user coordinates.</div>
							</td>
						</tr>
...
<!-- ============================== events summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the events documented in the class JXG.Coords.">
					...
					<tbody>
						...
						<tr>
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Coords.html#event:update">update</a></b>(ou, os)
								</div>
								<div class="description">Triggered whenever the coordinates change.</div>
							</td>
						</tr>
...
<!-- ============================== constructor details ==================== -->
			...
			<div class="details"><a name="constructor"> </a>
				...
				<div class="fixedFont">
						<b>JXG.Coords</b>(method, coordinates, board, emitter)
				</div>
					...
					Constructs a new Coordinates object.
						...
						<dl class="detailList">
							...
							<dt>
								...
								<dd>The type of coordinates given by the user. Accepted values are <b>COORDS_BY_SCREEN</b> and <b>COORDS_BY_USER</b>.</dd><br /><br />
							...
							<dt>
								...
								<dd>An array of affine coordinates.</dd><br /><br />
							...
							<dt>
								...
								<dd>A reference to a board.</dd><br /><br />
...
typed arrays.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{String}</span> <b>obj</b>
									
								</dt>
								<dd>Either 'srcCoords' or 'usrCoords'</dd>
							
								<dt>
									<span class="light fixedFont">{Number}</span> <b>offset</b>
									
								</dt>
								<dd>Offset, defaults to 0 if not given</dd>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{Array}</span> Returns copy of the coords array either as standard array or as
  typed array.</dd>
					...
					<b>distance</b>(coord_type, coordinates)
					...
					<div class="description">
						Calculate distance of one point to another.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{Number}</span> <b>coord_type</b>
									
								</dt>
								<dd>The type of coordinates used here. Possible values are <b>JXG.COORDS_BY_USER</b> and <b>JXG.COORDS_BY_SCREEN</b>.</dd>
							
								<dt>
									<span class="light fixedFont">{<a href="../symbols/JXG.Coords.html">JXG.Coords</a>}</span> <b>coordinates</b>
									
								</dt>
								<dd>The Coords object to which the distance is calculated.</dd>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{Number}</span> The distance</dd>
					...
					<a name="normalizeUsrCoords"> </a>
					<div class="fixedFont">&lt;private&gt; 
					
					
					<b>normalizeUsrCoords</b>()
					...
					<a name="setCoordinates"> </a>
					<div class="fixedFont">
					
					<span class="light">{<a href="../symbols/JXG.Coords.html">JXG.Coords</a>}</span>
					<b>setCoordinates</b>(coord_type, coordinates, doRound, noevent)
					...
					<div class="description">
						Set coordinates by either user coordinates or screen coordinates and recalculate the other one.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>The type of coordinates used here. Possible values are <b>COORDS_BY_USER</b> and <b>COORDS_BY_SCREEN</b>.</dd>
							
								<dt>
									<span class="light fixedFont">{Array}</span> <b>coordinates</b>
									
								</dt>
								<dd>An array of affine coordinates the Coords object is set to.</dd>
							
								<dt>
									<span class="light fixedFont">{Boolean}</span> <b>doRound</b>
									<i>Optional, Default: true</i>
								</dt>
								<dd>flag If true or null round the coordinates in usr2screen. This is used in smooth curve plotting.
The IE needs rounded coordinates. Id doRound==false we have to round in updatePathString.</dd>
							
								<dt>
									<span class="light fixedFont">{Boolean}</span> <b>noevent</b>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{<a href="../symbols/JXG.Coords.html">JXG.Coords</a>}</span> Reference to the coords object.</dd>
					...
					<div class="description">
						Triggered whenever the coordinates change.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{Array}</span> <b>ou</b>
									
								</dt>
								<dd>Old user coordinates</dd>
							
								<dt>
									<span class="light fixedFont">{Array}</span> <b>os</b>
									
								</dt>
								<dd>Old screen coordinates</dd>
