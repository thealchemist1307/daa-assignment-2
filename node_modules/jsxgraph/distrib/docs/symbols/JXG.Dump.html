...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JSXGraph Reference - JXG.Dump</title>
...
<p>
 <strong></strong><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#x21b3; <strong>JXG.Dump</strong><br /><br /></p>
...
<!-- ============================== class summary ========================== -->
			<p class="description">
					...
					<br /><br /><i>Defined in: </i> <a href="../symbols/src/src_utils_dump.js.html">dump.js</a>.
...
<!-- ============================== constructor summary ==================== -->			
			...
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class JXG.Dump.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/JXG.Dump.html#constructor">JXG.Dump</a></b>
							</div>
							<div class="description">The JXG.Dump namespace provides classes and methods to save a board to javascript.</div>
						</td>
					</tr>
				</tbody>
			</table>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class JXG.Dump.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">JXG.Dump.<b><a href="../symbols/JXG.Dump.html#.addMarkers">addMarkers</a></b>(board, markers, values)
								</div>
								<div class="description">Adds markers to every element of the board</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Dump.<b><a href="../symbols/JXG.Dump.html#.arrayToParamStr">arrayToParamStr</a></b>(a, converter)
								</div>
								<div class="description">Converts an array of different values into a parameter string that can be used by the code generators.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Dump.<b><a href="../symbols/JXG.Dump.html#.deleteMarkers">deleteMarkers</a></b>(board, markers)
								</div>
								<div class="description">Removes markers from every element on the board.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Dump.<b><a href="../symbols/JXG.Dump.html#.dump">dump</a></b>(board)
								</div>
								<div class="description">Generate a save-able structure with all elements.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Dump.<b><a href="../symbols/JXG.Dump.html#.minimizeObject">minimizeObject</a></b>(instance, s)
								</div>
								<div class="description">Eliminate default values given by <a href="../symbols/JXG.Options.html">JXG.Options</a> from the attributes object.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Dump.<b><a href="../symbols/JXG.Dump.html#.prepareAttributes">prepareAttributes</a></b>(board, obj)
								</div>
								<div class="description">Prepare the attributes object for an element to be dumped as JavaScript or JessieCode code.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Dump.<b><a href="../symbols/JXG.Dump.html#.str">str</a></b>(s)
								</div>
								<div class="description">Stringifies a string, i.e.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Dump.<b><a href="../symbols/JXG.Dump.html#.toJavaScript">toJavaScript</a></b>(board)
								</div>
								<div class="description">Saves the construction in <tt>board</tt> to JavaScript.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Dump.<b><a href="../symbols/JXG.Dump.html#.toJCAN">toJCAN</a></b>(obj)
								</div>
								<div class="description">Converts a JavaScript object into a JCAN (JessieCode Attribute Notation) string.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Dump.<b><a href="../symbols/JXG.Dump.html#.toJessie">toJessie</a></b>(board)
								</div>
								<div class="description">Saves the construction in <tt>board</tt> to JessieCode.</div>
							</td>
						</tr>
...
<!-- ============================== method details ========================= -->		
				...
				<div class="sectionTitle">
					...
					<span class="light">JXG.Dump.</span><b>addMarkers</b>(board, markers, values)
					...
					<div class="description">
						Adds markers to every element of the board
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{Array|String}</span> <b>markers</b>
					...
					<a name=".arrayToParamStr"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					<span class="light">{String}</span>
					<span class="light">JXG.Dump.</span><b>arrayToParamStr</b>(a, converter)
					...
					<div class="description">
						Converts an array of different values into a parameter string that can be used by the code generators.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{function}</span> <b>converter</b>
									
								</dt>
								<dd>A function that is used to transform the elements of <tt>a</tt>. Usually
<a href="../symbols/JXG.html#.toJSON">JXG.toJSON</a> or <a href="../symbols/JXG.Dump.html#.toJCAN">JXG.Dump.toJCAN</a> are used.</dd>
					...
					<a name=".deleteMarkers"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					
					<span class="light">JXG.Dump.</span><b>deleteMarkers</b>(board, markers)
					...
					<span class="light">JXG.Dump.</span><b>dump</b>(board)
...
JXG.Dump#toJavaScript to generate the script.
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{Array}</span> An array with all metadata necessary to save the construction.</dd>
					...
					<a name=".minimizeObject"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					<span class="light">{Object}</span>
					<span class="light">JXG.Dump.</span><b>minimizeObject</b>(instance, s)
					
					</div>
					<div class="description">
						Eliminate default values given by <a href="../symbols/JXG.Options.html">JXG.Options</a> from the attributes object.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>Attribute object of the element</dd>
							
								<dt>
									<span class="light fixedFont">{Object}</span> <b>s</b>
									
								</dt>
								<dd>Arbitrary number of objects <tt>instance</tt> will be compared to. Usually these are
sub-objects of the <a href="../symbols/JXG.Board.html#options">JXG.Board#options</a> structure.</dd>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{Object}</span> Minimal attributes object</dd>
					...
					<span class="light">{Object}</span>
					<span class="light">JXG.Dump.</span><b>prepareAttributes</b>(board, obj)
					...
					<div class="description">
						Prepare the attributes object for an element to be dumped as JavaScript or JessieCode code.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>Geometry element which attributes object is generated</dd>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{Object}</span> An attributes object.</dd>
					...
					<span class="light">{String}</span>
					<span class="light">JXG.Dump.</span><b>str</b>(s)
					...
					<a name=".toJavaScript"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					<span class="light">{String}</span>
					<span class="light">JXG.Dump.</span><b>toJavaScript</b>(board)
					...
					<div class="description">
						Saves the construction in <tt>board</tt> to JavaScript.
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{String}</span> JavaScript</dd>
					...
					<span class="light">{String}</span>
					<span class="light">JXG.Dump.</span><b>toJCAN</b>(obj)
					...
					<div class="description">
						Converts a JavaScript object into a JCAN (JessieCode Attribute Notation) string.
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{String}</span> The given object stored in a JCAN string.</dd>
					...
					<span class="light">{String}</span>
					<span class="light">JXG.Dump.</span><b>toJessie</b>(board)
					...
					<div class="description">
						Saves the construction in <tt>board</tt> to JessieCode.
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{String}</span> JessieCode</dd>
