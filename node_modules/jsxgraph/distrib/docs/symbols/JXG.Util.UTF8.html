...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JSXGraph Reference - JXG.Util.UTF8</title>
...
<p>
 <strong></strong><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#x21b3; <strong>JXG.Util.UTF8</strong><br /><br /></p>
...
<!-- ============================== class summary ========================== -->
			<p class="description">
					...
					<br /><br /><i>Defined in: </i> <a href="../symbols/src/src_utils_encoding.js.html">encoding.js</a>.
...
<!-- ============================== constructor summary ==================== -->			
			...
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class JXG.Util.UTF8.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/JXG.Util.UTF8.html#constructor">JXG.Util.UTF8</a></b>
							</div>
							<div class="description">UTF8 encoding routines</div>
						</td>
					</tr>
				</tbody>
			</table>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class JXG.Util.UTF8.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">JXG.Util.UTF8.<b><a href="../symbols/JXG.Util.UTF8.html#.asciiCharCodeAt">asciiCharCodeAt</a></b>(str, i)
								</div>
								<div class="description">Extends the standard charCodeAt() method of the String class to find the ASCII char code of
a character at a given position in a UTF8 encoded string.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Util.UTF8.<b><a href="../symbols/JXG.Util.UTF8.html#.decode">decode</a></b>(utftext)
								</div>
								<div class="description">Decode a string from utf-8.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Util.UTF8.<b><a href="../symbols/JXG.Util.UTF8.html#.encode">encode</a></b>(string)
								</div>
								<div class="description">Encode a string to utf-8.</div>
							</td>
						</tr>
...
<!-- ============================== method details ========================= -->		
				...
				<div class="sectionTitle">
					...
					<a name=".asciiCharCodeAt"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					<span class="light">{Number}</span>
					<span class="light">JXG.Util.UTF8.</span><b>asciiCharCodeAt</b>(str, i)
...
a character at a given position in a UTF8 encoded string.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>position of the character</dd>
					...
					<span class="light">JXG.Util.UTF8.</span><b>decode</b>(utftext)
					...
					<div class="description">
						Decode a string from utf-8.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{String}</span> <b>utftext</b>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{String}</span> utf8 decoded string</dd>
					...
					<span class="light">{String}</span>
					<span class="light">JXG.Util.UTF8.</span><b>encode</b>(string)
					...
					<div class="description">
						Encode a string to utf-8.
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{String}</span> utf8 encoded string</dd>
