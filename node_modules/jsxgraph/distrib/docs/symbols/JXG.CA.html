...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JSXGraph Reference - JXG.CA</title>
...
<p>
 <strong></strong><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#x21b3; <strong>JXG.CA</strong><br /><br /></p>
...
<!-- ============================== class summary ========================== -->
			<p class="description">
					...
					<br /><br /><i>Defined in: </i> <a href="../symbols/src/src_parser_ca.js.html">ca.js</a>.
...
<!-- ============================== constructor summary ==================== -->			
			...
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class JXG.CA.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/JXG.CA.html#constructor">JXG.CA</a></b>(code, geonext, parser)
							</div>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class JXG.CA.">
					...
					<tbody>
						...
						<tr>
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.CA.html#expandDerivatives">expandDerivatives</a></b>(node, parent, ast)
								</div>
								<div class="description">f = map (x) -> x*sin(x);
Usages:
h = D(f, x);
h = map (x) -> D(f, x);</div>
							</td>
						...
						<tr>
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.CA.html#setMath">setMath</a></b>(node)
								</div>
								<div class="description">Declare all subnodes as math nodes,
i.e recursively set node.isMath = true;</div>
							</td>
						</tr>
...
<!-- ============================== constructor details ==================== -->
			...
			<div class="details"><a name="constructor"> </a>
				...
				<div class="fixedFont">
						<b>JXG.CA</b>(code, geonext, parser)
				</div>
...
<!-- ============================== method details ========================= -->		
				...
				<div class="sectionTitle">
					...
					<a name="expandDerivatives"> </a>
					<div class="fixedFont">
					
					
					<b>expandDerivatives</b>(node, parent, ast)
