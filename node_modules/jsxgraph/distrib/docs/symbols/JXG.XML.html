...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JSXGraph Reference - JXG.XML</title>
...
<p>
 <strong></strong><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#x21b3; <strong>JXG.XML</strong><br /><br /></p>
...
<!-- ============================== class summary ========================== -->
			<p class="description">
					...
					<br /><br /><i>Defined in: </i> <a href="../symbols/src/src_utils_xml.js.html">xml.js</a>.
...
<!-- ============================== constructor summary ==================== -->			
			...
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class JXG.XML.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/JXG.XML.html#constructor">JXG.XML</a></b>
							</div>
							<div class="description">Holds browser independent xml parsing routines.</div>
						</td>
					</tr>
				</tbody>
			</table>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class JXG.XML.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">JXG.XML.<b><a href="../symbols/JXG.XML.html#.cleanWhitespace">cleanWhitespace</a></b>(el)
								</div>
								<div class="description">Cleans out unneccessary whitespaces in a chunk of xml.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.XML.<b><a href="../symbols/JXG.XML.html#.parse">parse</a></b>(str)
								</div>
								<div class="description">Converts a given string into a XML tree.</div>
							</td>
						</tr>
...
<!-- ============================== method details ========================= -->		
				...
				<div class="sectionTitle">
					...
					<a name=".cleanWhitespace"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					
					<span class="light">JXG.XML.</span><b>cleanWhitespace</b>(el)
					...
					<span class="light">JXG.XML.</span><b>parse</b>(str)
					...
					<div class="description">
						Converts a given string into a XML tree.
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{Object}</span> The xml tree represented by the root node.</dd>
