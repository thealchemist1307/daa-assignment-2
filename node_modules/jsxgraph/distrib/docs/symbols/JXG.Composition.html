...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JSXGraph Reference - JXG.Composition</title>
...
<p>
 <strong></strong><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#x21b3; <strong>JXG.Composition</strong><br /><br /></p>
...
<!-- ============================== class summary ========================== -->
			<p class="description">
				JXG.Composition
					...
					<br /><br /><i>Defined in: </i> <a href="../symbols/src/src_base_composition.js.html">composition.js</a>.
...
<!-- ============================== constructor summary ==================== -->			
			...
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class JXG.Composition.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/JXG.Composition.html#constructor">JXG.Composition</a></b>(elements)
							</div>
							<div class="description">A composition is a simple container that manages none or more <a href="../symbols/JXG.GeometryElement.html">JXG.GeometryElement</a>s.</div>
						</td>
					</tr>
				</tbody>
			</table>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class JXG.Composition.">
					...
					<tbody>
						...
						<tr>
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Composition.html#add">add</a></b>(what, element)
								</div>
								<div class="description">Adds an element to the composition container.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Composition.html#fullUpdate">fullUpdate</a></b>()
								</div>
								<div class="description">Invokes fullUpdate for every stored element with a fullUpdate method and hands over the given arguments.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Composition.html#highlight">highlight</a></b>()
								</div>
								<div class="description">Invokes highlight for every stored element with a highlight method and hands over the given arguments.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Composition.html#noHighlight">noHighlight</a></b>()
								</div>
								<div class="description">Invokes noHighlight for every stored element with a noHighlight method and hands over the given arguments.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Composition.html#prepareUpdate">prepareUpdate</a></b>()
								</div>
								<div class="description">Invokes prepareUpdate for every stored element with a prepareUpdate method and hands over the given arguments.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Composition.html#remove">remove</a></b>(what)
								</div>
								<div class="description">Remove an element from the composition container.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Composition.html#setAttribute">setAttribute</a></b>()
								</div>
								<div class="description">Invokes setAttribute for every stored element with a setAttribute method and hands over the given arguments.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Composition.html#setParents">setParents</a></b>()
								</div>
								<div class="description">Invokes setParents for every stored element with a setParents method and hands over the given arguments.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Composition.html#update">update</a></b>()
								</div>
								<div class="description">Invokes update for every stored element with a update method and hands over the given arguments.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Composition.html#updateRenderer">updateRenderer</a></b>()
								</div>
								<div class="description">Invokes updateRenderer for every stored element with a updateRenderer method and hands over the given arguments.</div>
							</td>
						</tr>
...
<!-- ============================== constructor details ==================== -->
			...
			<div class="details"><a name="constructor"> </a>
				...
				<div class="fixedFont">
						<b>JXG.Composition</b>(elements)
				</div>
				
				<div class="description">
					A composition is a simple container that manages none or more <a href="../symbols/JXG.GeometryElement.html">JXG.GeometryElement</a>s.
						...
						<dl class="detailList">
							...
							<dt>
    								...
    								<span class="light fixedFont">{Object}</span>  <b>elements</b>
	    							
                                
                                
							</dt>
								<dd>A list of elements with a descriptive name for the element as the key and a reference
to the element as the value of every list entry. The name is used to access the element later on.</dd><br /><br />
				...
				<pre class="code">var p1 = board.create('point', [1, 2]),
					...
					<div class="description">
						Adds an element to the composition container.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>Descriptive name for the element, e.g. <em>startpoint</em> or <em>area</em>. This is used to
...
JavaScript.</dd>
								...
								<dt>
									<span class="light fixedFont">{<a href="../symbols/JXG.GeometryElement.html">JXG.GeometryElement</a>|<a href="../symbols/JXG.Composition.html">JXG.Composition</a>}</span> <b>element</b>
									
								</dt>
								<dd>A reference to the element that is to be added. This can be
another composition, too.</dd>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{Boolean}</span> True, if the element was added successfully. Reasons why adding the element failed include
using a reserved name and providing an invalid element.</dd>
...
See <a href="../symbols/JXG.GeometryElement.html#fullUpdate">JXG.GeometryElement#fullUpdate</a> for further description, valid parameters and return values.
...
See <a href="../symbols/JXG.GeometryElement.html#highlight">JXG.GeometryElement#highlight</a> for further description, valid parameters and return values.
...
See <a href="../symbols/JXG.GeometryElement.html#noHighlight">JXG.GeometryElement#noHighlight</a> for further description, valid parameters and return values.
...
See <a href="../symbols/JXG.GeometryElement.html#prepareUpdate">JXG.GeometryElement#prepareUpdate</a> for further description, valid parameters and return values.
					...
					<div class="description">
						Remove an element from the composition container.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>The name used to access the element.</dd>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{Boolean}</span> True, if the element has been removed successfully.</dd>
...
See <a href="../symbols/JXG.GeometryElement.html#setAttribute">JXG.GeometryElement#setAttribute</a> for further description, valid parameters and return values.
...
See <a href="../symbols/JXG.GeometryElement.html#setParents">JXG.GeometryElement#setParents</a> for further description, valid parameters and return values.
...
See <a href="../symbols/JXG.GeometryElement.html#update">JXG.GeometryElement#update</a> for further description, valid parameters and return values.
...
See <a href="../symbols/JXG.GeometryElement.html#updateRenderer">JXG.GeometryElement#updateRenderer</a> for further description, valid parameters and return values.
