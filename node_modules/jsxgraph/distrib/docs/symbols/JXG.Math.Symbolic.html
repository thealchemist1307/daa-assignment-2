...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JSXGraph Reference - JXG.Math.Symbolic</title>
...
<p>
 <strong></strong><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#x21b3; <strong>JXG.Math.Symbolic</strong><br /><br /></p>
...
<!-- ============================== class summary ========================== -->
			<p class="description">
					...
					<br /><br /><i>Defined in: </i> <a href="../symbols/src/src_math_symbolic.js.html">symbolic.js</a>.
...
<!-- ============================== constructor summary ==================== -->			
			...
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class JXG.Math.Symbolic.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/JXG.Math.Symbolic.html#constructor">JXG.Math.Symbolic</a></b>
							</div>
							<div class="description">The JXG.Math.Symbolic namespace holds algorithms for symbolic computations.</div>
						</td>
					</tr>
				</tbody>
			</table>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class JXG.Math.Symbolic.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">JXG.Math.Symbolic.<b><a href="../symbols/JXG.Math.Symbolic.html#.clearSymbolicCoordinates">clearSymbolicCoordinates</a></b>(board)
								</div>
								<div class="description">Clears all .symbolic.x and .symbolic.y members on every point of a given board.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Math.Symbolic.<b><a href="../symbols/JXG.Math.Symbolic.html#.generatePolynomials">generatePolynomials</a></b>(board, element, generateCoords)
								</div>
								<div class="description">Generates polynomials for a part of the construction including all the points from that
a specific element depends of.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Math.Symbolic.<b><a href="../symbols/JXG.Math.Symbolic.html#.generateSymbolicCoordinatesPartial">generateSymbolicCoordinatesPartial</a></b>(board, element, variable, append)
								</div>
								<div class="description">Generates symbolic coordinates for the part of a construction including all the elements from that
a specific element depends of.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Math.Symbolic.<b><a href="../symbols/JXG.Math.Symbolic.html#.geometricLocusByGroebnerBase">geometricLocusByGroebnerBase</a></b>(board, point)
								</div>
								<div class="description">Calculate geometric locus of a point given on a board.</div>
							</td>
						</tr>
...
<!-- ============================== method details ========================= -->		
				...
				<div class="sectionTitle">
					...
					<a name=".clearSymbolicCoordinates"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					
					<span class="light">JXG.Math.Symbolic.</span><b>clearSymbolicCoordinates</b>(board)
					...
					<div class="description">
						Clears all .symbolic.x and .symbolic.y members on every point of a given board.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>The board that's points get cleared their symbolic coordinates.</dd>
					...
					<a name=".generatePolynomials"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					<span class="light">{Array}</span>
					<span class="light">JXG.Math.Symbolic.</span><b>generatePolynomials</b>(board, element, generateCoords)
...
a specific element depends of.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>The board that's points polynomials will be generated.</dd>
							
								<dt>
									<span class="light fixedFont">{<a href="../symbols/JXG.GeometryElement.html">JXG.GeometryElement</a>}</span> <b>element</b>
									
								</dt>
								<dd>All points in the set of ancestors of this element are used to generate the set of polynomials.</dd>
							
								<dt>
									<span class="light fixedFont">{Boolean}</span> <b>generateCoords</b>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{Array}</span> An array of polynomials as strings.</dd>
					...
					<a name=".generateSymbolicCoordinatesPartial"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					<span class="light">{Number}</span>
					<span class="light">JXG.Math.Symbolic.</span><b>generateSymbolicCoordinatesPartial</b>(board, element, variable, append)
...
a specific element depends of. These coordinates will be stored in GeometryElement.symbolic.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>The board that's element get some symbolic coordinates.</dd>
							
								<dt>
									<span class="light fixedFont">{<a href="../symbols/JXG.GeometryElement.html">JXG.GeometryElement</a>}</span> <b>element</b>
									
								</dt>
								<dd>All ancestor of this element get symbolic coordinates.</dd>
							
								<dt>
									<span class="light fixedFont">{String}</span> <b>variable</b>
									
								</dt>
								<dd>Name for the coordinates, e.g. x or u.</dd>
							
								<dt>
									<span class="light fixedFont">{String}</span> <b>append</b>
									
								</dt>
								<dd>Method for how to append the number of the coordinates. Possible values are
                       'underscore' (e.g. x_2), 'none' (e.g. x2), 'brace' (e.g. x[2]).</dd>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{Number}</span> Number of coordinates given.</dd>
					...
					<a name=".geometricLocusByGroebnerBase"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					<span class="light">{Array}</span>
					<span class="light">JXG.Math.Symbolic.</span><b>geometricLocusByGroebnerBase</b>(board, point)
					...
					<div class="description">
						Calculate geometric locus of a point given on a board. Invokes python script on server.
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{Array}</span> An array of points.</dd>
