...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JSXGraph Reference - Transformation</title>
...
<p>
 <strong><a href="../symbols/JXG.Transformation.html">JXG.Transformation</a></strong><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#x21b3; <strong>Transformation</strong><br /><br /></p>
...
<!-- ============================== class summary ========================== -->
			<p class="description">
                ...
                <br />Extends
                    <a href="../symbols/JXG.Transformation.html">JXG.Transformation</a>.
                
			</p>

<!-- ============================== constructor summary ==================== -->			
			
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class Transformation.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/Transformation.html#constructor">Transformation</a></b>
							</div>
...
<!-- ============================== methods summary ======================== -->
				...
				<dt>Methods borrowed from class <a href="../symbols/JXG.Transformation.html">JXG.Transformation</a>: </dt><dd><a href="../symbols/JXG.Transformation.html#apply">apply</a>, <a href="../symbols/JXG.Transformation.html#applyOnce">applyOnce</a>, <a href="../symbols/JXG.Transformation.html#bindTo">bindTo</a>, <a href="../symbols/JXG.Transformation.html#melt">melt</a>, <a href="../symbols/JXG.Transformation.html#setAttribute">setAttribute</a>, <a href="../symbols/JXG.Transformation.html#setMatrix">setMatrix</a>, <a href="../symbols/JXG.Transformation.html#setProperty">setProperty</a>, <a href="../symbols/JXG.Transformation.html#update">update</a></dd>
				</dl>
				...
				<div class="description">
					A transformation consists of a 3x3 matrix, i.e. it is a projective transformation.
						...
						<dl class="detailList">
                            ...
                            with type &quot;transformation&quot;.<br /><br />
							...
							<dt>
                                    ...
                                    <span class="light fixedFont">{number|function}</span> <b>The</b><br />
                                    <br />
                                
							</dt>
								<dd>parameters depend on the transformation type, supplied as attribute 'type'.
...
( g  h  i )   ( y )
				...
				<pre class="code">// The point B is determined by taking twice the vector A from the origin
...
<script type="text/javascript">
    ...
    var p0 = board.create('point', [0, 3], {name: 'A'}),
        ...
        p1 = board.create('point', [p0, t], {color: 'blue'});
				...
				<pre class="code">// The point B is the result of scaling the point A with factor 2 in horizontal direction
...
<script type="text/javascript">
    ...
    var p1 = board.create('point', [1, 1]),
        ...
        p2 = board.create('point', [p1, t], {color: 'blue'});
				...
				<pre class="code">// The point B is rotated around C which gives point D. The angle is determined
...
<script type="text/javascript">
    ...
    var p0 = board.create('point', [0, 3], {name: 'A'}),
        ...
        p3 = board.create('point', [p1, t], {color: 'blue'});
				...
				<pre class="code">// A concatenation of several transformations.
var p1 = board.create('point', [1, 1]),
...
<script type="text/javascript">
    ...
    var p1 = board.create('point', [1, 1]),
        ...
        p2 = board.create('point', [p1, [t1, t2, t3]], {color: 'blue'});
				...
				<pre class="code">// Reflection of point A
var p1 = board.create('point', [1, 1]),
...
<script type="text/javascript">
    ...
    var p1 = board.create('point', [1, 1]),
        ...
        p4 = board.create('point', [p1, t], {color: 'blue'});
				...
				<pre class="code">// One time application of a transform to points A, B
var p1 = board.create('point', [1, 1]),
...
<script type="text/javascript">
    ...
    t.applyOnce([p1, p2]);
				...
				<pre class="code">// Construct a square of side length 2 with the
