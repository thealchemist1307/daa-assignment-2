...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JSXGraph Reference - JXG.Transformation</title>
...
<p>
 <strong></strong><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#x21b3; <strong>JXG.Transformation</strong><br /><br /></p>


<!-- ============================== class summary ========================== -->
			<p class="description">
				Creates a new transformation object. Do not use this constructor to create a transformation. Use <a href="../symbols/JXG.Board.html#create">JXG.Board#create</a> with
type <a href="../symbols/Transformation.html">Transformation</a> instead.
				
				
					<br /><br /><i>Defined in: </i> <a href="../symbols/src/src_base_transformation.js.html">transformation.js</a>.
...
<!-- ============================== constructor summary ==================== -->			
			...
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class JXG.Transformation.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/JXG.Transformation.html#constructor">JXG.Transformation</a></b>(board, type, params)
							</div>
							<div class="description">A transformation consists of a 3x3 matrix, i.e.</div>
						</td>
					</tr>
				</tbody>
			</table>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class JXG.Transformation.">
					...
					<tbody>
						...
						<tr>
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Transformation.html#apply">apply</a></b>(p, 'self')
								</div>
								<div class="description">Transform a GeometryElement:
First, the transformation matrix is updated, then do the matrix-vector-multiplication.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Transformation.html#applyOnce">applyOnce</a></b>(p)
								</div>
								<div class="description">Applies a transformation once to a GeometryElement or an array of elements.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Transformation.html#bindTo">bindTo</a></b>(p)
								</div>
								<div class="description">Binds a transformation to a GeometryElement or an array of elements.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Transformation.html#melt">melt</a></b>(t)
								</div>
								<div class="description">Combine two transformations to one transformation.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Transformation.html#setAttribute">setAttribute</a></b>(term)
								</div>
								<div class="description">Empty method.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Transformation.html#setMatrix">setMatrix</a></b>(board, type, params, x,y, scale_x,scale_y, line|point_pair|"four, angle,x,y|angle,[x,y], shear_x,shear_y, a,b,c,d,e,f,g,h,i)
								</div>
								<div class="description">Set the transformation matrix for different types of standard transforms.</div>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Transformation.html#setProperty">setProperty</a></b>(term)
								</div>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Transformation.html#update">update</a></b>()
								</div>
...
<!-- ============================== constructor details ==================== -->
			...
			<div class="details"><a name="constructor"> </a>
				...
				<div class="fixedFont">
						<b>JXG.Transformation</b>(board, type, params)
				</div>
...
<li> 'generic'
							...
							<dt>
								...
								<dd>The parameters depend on the transformation type
...
First, the transformation matrix is updated, then do the matrix-vector-multiplication.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{<a href="../symbols/JXG.GeometryElement.html">JXG.GeometryElement</a>}</span> <b>p</b>
									
								</dt>
								<dd>element which is transformed</dd>
							
								<dt>
									<span class="light fixedFont">{String}</span> <b>'self'</b>
									
								</dt>
								<dd>Apply the transformation to the initialCoords instead of the coords if this is set.</dd>
...
and will overwrite the transformed coordinates.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{<a href="../symbols/JXG.Point.html">JXG.Point</a>|Array}</span> <b>p</b>
...
apply the transformation, a call of board.update() has to follow.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{Array|JXG.Object}</span> <b>p</b>
									
								</dt>
								<dd>JXG.Object or array of JXG.Object to
                           which the transformation is bound to.</dd>
					...
					<span class="light">{JXG.Transform}</span>
					<b>melt</b>(t)
...
i.e. (this) = (t) join (this)
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{JXG.Transform}</span> <b>t</b>
									
								</dt>
								<dd>Transformation which is the left multiplicand</dd>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{JXG.Transform}</span> the transformation object.</dd>
					...
					<div class="description">
						Empty method. Unused.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{Object}</span> <b>term</b>
									
								</dt>
								<dd>Key-value pairs of the attributes.</dd>
					...
					<b>setMatrix</b>(board, type, params, x,y, scale_x,scale_y, line|point_pair|"four, angle,x,y|angle,[x,y], shear_x,shear_y, a,b,c,d,e,f,g,h,i)
					...
					<div class="description">
						Set the transformation matrix for different types of standard transforms.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>Transformation type, possible values are
                       ...
                       'shear', 'generic'.</dd>
								...
								<dd>Parameters for the various transformation types.

<p>These are</dd>
							
								<dt>
									<span class="light fixedFont">{Array}</span> <b>x,y</b>
									
								</dt>
								<dd>Shift vector (number or function) in case of 'translate'.</dd>
							
								<dt>
									<span class="light fixedFont">{Array}</span> <b>scale_x,scale_y</b>
									
								</dt>
								<dd>Scale vector (number or function) in case of 'scale'.</dd>
							
								<dt>
									<span class="light fixedFont">{Array}</span> <b>line|point_pair|"four</b>
									
								</dt>
								<dd>coordinates" In case of 'reflect' the parameters could
               be a line, a pair of points or four number (or functions) p_x, p_y, q_x, q_y,
               determining a line through points (p_x, p_y) and (q_x, q_y).</dd>
							
								<dt>
									<span class="light fixedFont">{Array}</span> <b>angle,x,y|angle,[x,y]</b>
									
								</dt>
								<dd>In case of 'rotate' the parameters are an angle or angle function,
               ...
               rotation center. If the rotation center is not given, the transformation rotates around (0,0).</dd>
							
								<dt>
									<span class="light fixedFont">{Array}</span> <b>shear_x,shear_y</b>
									
								</dt>
								<dd>Shear vector (number or function) in case of 'shear'.</dd>
							
								<dt>
									<span class="light fixedFont">{Array}</span> <b>a,b,c,d,e,f,g,h,i</b>
									
								</dt>
								<dd>Nine matrix entries (numbers or functions) for a generic
...
( g  h  i )   ( y )
					...
					<div class="description">
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{JXG.Transform}</span> returns pointer to itself</dd>
