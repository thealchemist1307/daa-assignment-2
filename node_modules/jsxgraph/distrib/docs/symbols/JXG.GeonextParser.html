...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JSXGraph Reference - JXG.GeonextParser</title>
...
<p>
 <strong></strong><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#x21b3; <strong>JXG.GeonextParser</strong><br /><br /></p>
...
<!-- ============================== class summary ========================== -->
			<p class="description">
					...
					<br /><br /><i>Defined in: </i> <a href="../symbols/src/src_parser_geonext.js.html">geonext.js</a>.
...
<!-- ============================== constructor summary ==================== -->			
			...
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class JXG.GeonextParser.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/JXG.GeonextParser.html#constructor">JXG.GeonextParser</a></b>
							</div>
							<div class="description">Parser helper routines.</div>
						</td>
					</tr>
				</tbody>
			</table>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class JXG.GeonextParser.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">JXG.GeonextParser.<b><a href="../symbols/JXG.GeonextParser.html#.findDependencies">findDependencies</a></b>(me, term, board)
								</div>
								<div class="description">Finds dependencies in a given term and resolves them by adding the
dependent object to the found objects child elements.</div>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.GeonextParser.<b><a href="../symbols/JXG.GeonextParser.html#.geonext2JS">geonext2JS</a></b>(term, board)
								</div>
								<div class="description">Converts the given algebraic expression in GEONE<sub>x</sub>T syntax into an equivalent expression in JavaScript syntax.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.GeonextParser.<b><a href="../symbols/JXG.GeonextParser.html#.gxt2jc">gxt2jc</a></b>(term, board)
								</div>
								<div class="description">Converts the given algebraic expression in GEONE<sub>x</sub>T syntax into an equivalent expression in JessieCode syntax.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.GeonextParser.<b><a href="../symbols/JXG.GeonextParser.html#.replaceIdByObj">replaceIdByObj</a></b>(term)
								</div>
								<div class="description">Replaces element ids in terms by element this.board.objects['id'].</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.GeonextParser.<b><a href="../symbols/JXG.GeonextParser.html#.replaceIf">replaceIf</a></b>(te)
								</div>
								<div class="description">Converts expression of the form <i>If(a,b,c)</i> into <i>(a)?(b):(c)/i>.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.GeonextParser.<b><a href="../symbols/JXG.GeonextParser.html#.replaceNameById">replaceNameById</a></b>(term, board, jc)
								</div>
								<div class="description">Replace an element's name in terms by an element's id.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.GeonextParser.<b><a href="../symbols/JXG.GeonextParser.html#.replacePow">replacePow</a></b>(te)
								</div>
								<div class="description">Converts expression of the form <i>leftop^rightop</i> into <i>Math.pow(leftop,rightop)</i>.</div>
							</td>
						</tr>
...
<!-- ============================== method details ========================= -->		
				...
				<div class="sectionTitle">
					...
					<span class="light">JXG.GeonextParser.</span><b>findDependencies</b>(me, term, board)
...
dependent object to the found objects child elements.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{<a href="../symbols/JXG.GeometryElement.html">JXG.GeometryElement</a>}</span> <b>me</b>
									
								</dt>
								<dd>Object depending on objects in given term.</dd>
							
								<dt>
									<span class="light fixedFont">{String}</span> <b>term</b>
					...
					<span class="light">JXG.GeonextParser.</span><b>geonext2JS</b>(term, board)
					...
					<div class="description">
						Converts the given algebraic expression in GEONE<sub>x</sub>T syntax into an equivalent expression in JavaScript syntax.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>Expression in GEONExT syntax</dd>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{String}</span> Given expression translated to JavaScript.</dd>
					...
					<span class="light">{String}</span>
					<span class="light">JXG.GeonextParser.</span><b>gxt2jc</b>(term, board)
					...
					<a name=".replaceIdByObj"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					<span class="light">{String}</span>
					<span class="light">JXG.GeonextParser.</span><b>replaceIdByObj</b>(term)
					...
					<div class="description">
						Replaces element ids in terms by element this.board.objects['id'].
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>A GEONE<sub>x</sub>T function string with JSXGraph ids in it.</dd>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{String}</span> The input string with element ids replaced by this.board.objects["id"].</dd>
					...
					<span class="light">{String}</span>
					<span class="light">JXG.GeonextParser.</span><b>replaceIf</b>(te)
					...
					<div class="description">
						Converts expression of the form <i>If(a,b,c)</i> into <i>(a)?(b):(c)/i>.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>Expression of the form <i>If(a,b,c)</i></dd>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{String}</span> Converted expression.</dd>
					...
					<a name=".replaceNameById"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					<span class="light">{String}</span>
					<span class="light">JXG.GeonextParser.</span><b>replaceNameById</b>(term, board, jc)
					...
					<div class="description">
						Replace an element's name in terms by an element's id.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>Term containing names of elements.</dd>
							
								<dt>
									<span class="light fixedFont">{<a href="../symbols/JXG.Board.html">JXG.Board</a>}</span> <b>board</b>
									
								</dt>
								<dd>Reference to the board the elements are on.</dd>
							
								<dt>
									<span class="light fixedFont">{Boolean}</span> <b>jc</b>
									<i>Optional, Default: false</i>
								</dt>
								<dd>If true, all id's will be surrounded by <tt>$('</tt> and <tt>')</tt>.</dd>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{String}</span> The same string with names replaced by ids.</dd>
					...
					<span class="light">{String}</span>
					<span class="light">JXG.GeonextParser.</span><b>replacePow</b>(te)
					...
					<div class="description">
						Converts expression of the form <i>leftop^rightop</i> into <i>Math.pow(leftop,rightop)</i>.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>Expression of the form <i>leftop^rightop</i></dd>
