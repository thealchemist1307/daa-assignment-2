...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JSXGraph Reference - JXG.Server</title>
...
<p>
 <strong></strong><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#x21b3; <strong>JXG.Server</strong><br /><br /></p>
...
<!-- ============================== class summary ========================== -->
			<p class="description">
				JXG.Server namespace holding functions to load JXG server modules.
					...
					<br /><br /><i>Defined in: </i> <a href="../symbols/src/src_server_server.js.html">server.js</a>.
...
<!-- ============================== constructor summary ==================== -->			
			...
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class JXG.Server.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/JXG.Server.html#constructor">JXG.Server</a></b>
							</div>
...
<!-- ============================== properties summary ===================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the fields documented in the class JXG.Server.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">
								JXG.Server.<b><a href="../symbols/JXG.Server.html#.runningCalls">runningCalls</a></b>
								</div>
								<div class="description">Stores all asynchronous calls to server which aren't finished yet.</div>
							</td>
						</tr>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class JXG.Server.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">JXG.Server.<b><a href="../symbols/JXG.Server.html#.callServer">callServer</a></b>(action, callback, data, sync)
								</div>
								<div class="description">The main method of JXG.Server.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Server.<b><a href="../symbols/JXG.Server.html#.handleError">handleError</a></b>(data)
								</div>
								<div class="description">Handles errors, just a default implementation, can be overwritten by you, if you want to handle errors by yourself.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Server.<b><a href="../symbols/JXG.Server.html#.loadModule">loadModule</a></b>(module)
								</div>
								<div class="description">Loads a module from the server.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Server.<b><a href="../symbols/JXG.Server.html#.loadModule_cb">loadModule_cb</a></b>(data)
								</div>
								<div class="description">Callback for the default action 'load'.</div>
							</td>
						</tr>
...
<!-- ============================== field details ========================== -->
				...
				<div class="sectionTitle">
					...
					<a name=".runningCalls"> </a>
					<div class="fixedFont">&lt;private&gt; &lt;static&gt; 
					
					
					<span class="light">JXG.Server.</span><b>runningCalls</b>
...
<!-- ============================== method details ========================= -->		
				...
				<div class="sectionTitle">
					...
					<span class="light">JXG.Server.</span><b>callServer</b>(action, callback, data, sync)
...
module. See the correspondings server module readme.</dd>
					...
					<span class="light">JXG.Server.</span><b>handleError</b>(data)
					...
					<div class="description">
						Handles errors, just a default implementation, can be overwritten by you, if you want to handle errors by yourself.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>An object holding a field of type string named message handling the error described in the message string.</dd>
					...
					<span class="light">JXG.Server.</span><b>loadModule</b>(module)
					...
					<div class="description">
						Loads a module from the server.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>A string containing the module. Has to match the filename of the Python module on the server exactly including
lower and upper case letters without the file ending .py.</dd>
					...
					<a name=".loadModule_cb"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					
					<span class="light">JXG.Server.</span><b>loadModule_cb</b>(data)
