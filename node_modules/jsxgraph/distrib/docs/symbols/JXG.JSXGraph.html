...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JSXGraph Reference - JXG.JSXGraph</title>
...
<p>
 <strong></strong><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#x21b3; <strong>JXG.JSXGraph</strong><br /><br /></p>
...
to load, save, create and free a board.
					...
					<br /><br /><i>Defined in: </i> <a href="../symbols/src/src_jsxgraph.js.html">jsxgraph.js</a>.
...
<!-- ============================== constructor summary ==================== -->			
			...
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class JXG.JSXGraph.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/JXG.JSXGraph.html#constructor">JXG.JSXGraph</a></b>()
							</div>
							<div class="description">Constructs a new JSXGraph singleton object.</div>
						</td>
					</tr>
				</tbody>
			</table>
...
<!-- ============================== properties summary ===================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the fields documented in the class JXG.JSXGraph.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">
								JXG.JSXGraph.<b><a href="../symbols/JXG.JSXGraph.html#.rendererType">rendererType</a></b>
								</div>
								<div class="description">Stores the renderer that is used to draw the boards.</div>
							</td>
						</tr>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class JXG.JSXGraph.">
					...
					<tbody>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.JSXGraph.<b><a href="../symbols/JXG.JSXGraph.html#.freeBoard">freeBoard</a></b>(board)
								</div>
								<div class="description">Delete a board and all its contents.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.JSXGraph.<b><a href="../symbols/JXG.JSXGraph.html#.initBoard">initBoard</a></b>(box, attributes)
								</div>
								<div class="description">Initialise a new board.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.JSXGraph.<b><a href="../symbols/JXG.JSXGraph.html#.loadBoardFromFile">loadBoardFromFile</a></b>(box, file, format, attributes, callback)
								</div>
								<div class="description">Load a board from a file containing a construction made with either GEONExT,
Intergeo, Geogebra, or Cinderella.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.JSXGraph.<b><a href="../symbols/JXG.JSXGraph.html#.loadBoardFromString">loadBoardFromString</a></b>(box, string, format, attributes, callback)
								</div>
								<div class="description">Load a board from a base64 encoded string containing a construction made with either GEONExT,
Intergeo, Geogebra, or Cinderella.</div>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">JXG.JSXGraph.<b><a href="../symbols/JXG.JSXGraph.html#.registerElement">registerElement</a></b>(element, creator)
								</div>
...
<!-- ============================== field details ========================== -->
				...
				<div class="sectionTitle">
					...
					<span class="light">JXG.JSXGraph.</span><b>rendererType</b>
...
<!-- ============================== method details ========================= -->		
				...
				<div class="sectionTitle">
					...
					<span class="light">JXG.JSXGraph.</span><b>freeBoard</b>(board)
					...
					<div class="description">
						Delete a board and all its contents.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{<a href="../symbols/JXG.Board.html">JXG.Board</a>|String}</span> <b>board</b>
									
								</dt>
								<dd>HTML-ID to the DOM-element in which the board is drawn.</dd>
					...
					<span class="light">JXG.JSXGraph.</span><b>initBoard</b>(box, attributes)
					...
					<div class="description">
						Initialise a new board.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{String}</span> <b>box</b>
									
								</dt>
								<dd>Html-ID to the Html-element in which the board is painted.</dd>
							
								<dt>
									<span class="light fixedFont">{Object}</span> <b>attributes</b>
									
								</dt>
								<dd>An object that sets some of the board properties. Most of these properties can be set via JXG.Options.</dd>
							
								<dt>
									<span class="light fixedFont">{Array}</span> <b>attributes.boundingbox</b>
									<i>Optional, Default: [-5, 5, 5, -5]</i>
								</dt>
								<dd>An array containing four numbers describing the left, top, right and bottom boundary of the board in user coordinates</dd>
							
								<dt>
									<span class="light fixedFont">{Boolean}</span> <b>attributes.keepaspectratio</b>
									<i>Optional, Default: false</i>
								</dt>
								<dd>If <tt>true</tt>, the bounding box is adjusted to the same aspect ratio as the aspect ratio of the div containing the board.</dd>
							
								<dt>
									<span class="light fixedFont">{Boolean}</span> <b>attributes.showCopyright</b>
									<i>Optional, Default: false</i>
								</dt>
								<dd>Show the copyright string in the top left corner.</dd>
							
								<dt>
									<span class="light fixedFont">{Boolean}</span> <b>attributes.showNavigation</b>
									<i>Optional, Default: false</i>
								</dt>
								<dd>Show the navigation buttons in the bottom right corner.</dd>
							
								<dt>
									<span class="light fixedFont">{Object}</span> <b>attributes.zoom</b>
									<i>Optional</i>
								</dt>
								<dd>Allow the user to zoom with the mouse wheel or the two-fingers-zoom gesture.</dd>
							
								<dt>
									<span class="light fixedFont">{Object}</span> <b>attributes.pan</b>
									<i>Optional</i>
								</dt>
								<dd>Allow the user to pan with shift+drag mouse or two-fingers-pan gesture.</dd>
							
								<dt>
									<span class="light fixedFont">{Boolean}</span> <b>attributes.axis</b>
									<i>Optional, Default: false</i>
								</dt>
								<dd>If set to true, show the axis. Can also be set to an object that is given to both axes as an attribute object.</dd>
							
								<dt>
									<span class="light fixedFont">{Boolean|Object}</span> <b>attributes.grid</b>
									<i>Optional</i>
								</dt>
								<dd>If set to true, shows the grid. Can also bet set to an object that is given to the grid as its attribute object.</dd>
							
								<dt>
									<span class="light fixedFont">{Boolean}</span> <b>attributes.registerEvents</b>
									<i>Optional, Default: true</i>
								</dt>
								<dd>Register mouse / touch events.</dd>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{<a href="../symbols/JXG.Board.html">JXG.Board</a>}</span> Reference to the created board.</dd>
					...
					<a name=".loadBoardFromFile"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					<span class="light">{<a href="../symbols/JXG.Board.html">JXG.Board</a>}</span>
					<span class="light">JXG.JSXGraph.</span><b>loadBoardFromFile</b>(box, file, format, attributes, callback)
...
Intergeo, Geogebra, or Cinderella.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>containing the file format: 'Geonext' or 'Intergeo'.</dd>
							...
							<dt class="heading">See:</dt>
								...
								<dd><a href="../symbols/JXG.html#.FileReader">JXG.FileReader</a></dd>
							
								<dd>JXG.GeonextReader</dd>
							
								<dd>JXG.GeogebraReader</dd>
							
								<dd>JXG.IntergeoReader</dd>
							
								<dd>JXG.CinderellaReader</dd>
					...
					<a name=".loadBoardFromString"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					<span class="light">{<a href="../symbols/JXG.Board.html">JXG.Board</a>}</span>
					<span class="light">JXG.JSXGraph.</span><b>loadBoardFromString</b>(box, string, format, attributes, callback)
...
Intergeo, Geogebra, or Cinderella.
					...
					<span class="light">JXG.JSXGraph.</span><b>registerElement</b>(element, creator)
