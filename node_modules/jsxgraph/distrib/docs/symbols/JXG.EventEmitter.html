...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JSXGraph Reference - JXG.EventEmitter</title>
...
<p>
 <strong></strong><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#x21b3; <strong>JXG.EventEmitter</strong><br /><br /></p>
...
<!-- ============================== class summary ========================== -->
			<p class="description">
					...
					<br /><br /><i>Defined in: </i> <a href="../symbols/src/src_utils_event.js.html">event.js</a>.
...
<!-- ============================== constructor summary ==================== -->			
			...
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class JXG.EventEmitter.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/JXG.EventEmitter.html#constructor">JXG.EventEmitter</a></b>
							</div>
							<div class="description">Event namespace</div>
						</td>
					</tr>
				</tbody>
			</table>
...
<!-- ============================== properties summary ===================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the fields documented in the class JXG.EventEmitter.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">
								JXG.EventEmitter.<b><a href="../symbols/JXG.EventEmitter.html#.eventHandlers">eventHandlers</a></b>
								</div>
								<div class="description">Holds the registered event handlers.</div>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">
								JXG.EventEmitter.<b><a href="../symbols/JXG.EventEmitter.html#.suspended">suspended</a></b>
								</div>
								<div class="description">Events can be suspended to prevent endless loops.</div>
							</td>
						</tr>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class JXG.EventEmitter.">
					...
					<tbody>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.EventEmitter.<b><a href="../symbols/JXG.EventEmitter.html#.eventify">eventify</a></b>(o)
								</div>
								<div class="description">Implements the functionality from this interface in the given object.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.EventEmitter.<b><a href="../symbols/JXG.EventEmitter.html#.off">off</a></b>(event, handler)
								</div>
								<div class="description">Unregister an event handler.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.EventEmitter.<b><a href="../symbols/JXG.EventEmitter.html#.on">on</a></b>(event, handler, context)
								</div>
								<div class="description">Register a new event handler.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.EventEmitter.<b><a href="../symbols/JXG.EventEmitter.html#.trigger">trigger</a></b>(event, args)
								</div>
								<div class="description">Triggers all event handlers of this element for a given event.</div>
							</td>
						</tr>
...
<!-- ============================== field details ========================== -->
				...
				<div class="sectionTitle">
					...
					<span class="light">JXG.EventEmitter.</span><b>eventHandlers</b>
					...
					<span class="light">{Object}</span>
					<span class="light">JXG.EventEmitter.</span><b>suspended</b>
...
<!-- ============================== method details ========================= -->		
				...
				<div class="sectionTitle">
					...
					<span class="light">JXG.EventEmitter.</span><b>eventify</b>(o)
...
<pre>@borrows JXG.EventEmitter#on as this.on</pre>
					...
					<span class="light">JXG.EventEmitter.</span><b>off</b>(event, handler)
					...
					<span class="light">JXG.EventEmitter.</span><b>on</b>(event, handler, context)
...
the EventEmitter interface.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>The context the handler will be called in, default is the element itself.</dd>
					...
					<span class="light">JXG.EventEmitter.</span><b>trigger</b>(event, args)
					...
					<div class="description">
						Triggers all event handlers of this element for a given event.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{Array}</span> <b>event</b>
								...
								<dd>The arguments passed onto the event handler</dd>
