...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JSXGraph Reference - JXG.Server.modules</title>
...
<!-- ============================== class title ============================ -->
			<h1 class="classTitle">
				...
				Namespace JXG.Server.modules
			</h1>

<!-- ============================== Inheritance tree ========================== -->

<p>
 <strong></strong><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#x21b3; <strong>JXG.Server.modules</strong><br /><br /></p>
...
<!-- ============================== constructor summary ==================== -->			
			...
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class JXG.Server.modules.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/JXG.Server.modules.html#constructor">JXG.Server.modules</a></b>
							</div>
							<div class="description">This is where all of a module's handlers are accessed from.</div>
						</td>
					</tr>
				</tbody>
			</table>
