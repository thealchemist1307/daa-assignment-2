...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JSXGraph Reference - JXG.Util.Base64</title>
...
<p>
 <strong></strong><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#x21b3; <strong>JXG.Util.Base64</strong><br /><br /></p>
...
<!-- ============================== class summary ========================== -->
			<p class="description">
					...
					<br /><br /><i>Defined in: </i> <a href="../symbols/src/src_utils_base64.js.html">base64.js</a>.
...
<!-- ============================== constructor summary ==================== -->			
			...
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class JXG.Util.Base64.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/JXG.Util.Base64.html#constructor">JXG.Util.Base64</a></b>
							</div>
							<div class="description">Base64 routines</div>
						</td>
					</tr>
				</tbody>
			</table>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class JXG.Util.Base64.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">JXG.Util.Base64.<b><a href="../symbols/JXG.Util.Base64.html#.decode">decode</a></b>(input, utf8)
								</div>
								<div class="description">Decode from Base64</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Util.Base64.<b><a href="../symbols/JXG.Util.Base64.html#.decodeAsArray">decodeAsArray</a></b>(input)
								</div>
								<div class="description">Decode the base64 input data as an array</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Util.Base64.<b><a href="../symbols/JXG.Util.Base64.html#.encode">encode</a></b>(input)
								</div>
								<div class="description">Encode the given string.</div>
							</td>
						</tr>
...
<!-- ============================== method details ========================= -->		
				...
				<div class="sectionTitle">
					...
					<span class="light">JXG.Util.Base64.</span><b>decode</b>(input, utf8)
					...
					<div class="description">
						Decode from Base64
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{Boolean}</span> <b>utf8</b>
									
								</dt>
								<dd>In case this parameter is true <a href="../symbols/JXG.Util.UTF8.html#.decode">JXG.Util.UTF8.decode</a> will be applied to
the result of the base64 decoder.</dd>
							...
							<dt class="heading">Throws:</dt>
								...
								<dd>If the string has the wrong length.</dd>
					...
					<a name=".decodeAsArray"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					<span class="light">{Array}</span>
					<span class="light">JXG.Util.Base64.</span><b>decodeAsArray</b>(input)
					...
					<span class="light">{string}</span>
					<span class="light">JXG.Util.Base64.</span><b>encode</b>(input)
					...
					<div class="description">
						Encode the given string.
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{string}</span> base64 encoded version of the input string.</dd>
