...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JSXGraph Reference - JXG.Math.Poly.Monomial</title>
...
<p>
 <strong></strong><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#x21b3; <strong>JXG.Math.Poly.Monomial</strong><br /><br /></p>
...
<!-- ============================== constructor summary ==================== -->			
			...
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class JXG.Math.Poly.Monomial.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/JXG.Math.Poly.Monomial.html#constructor">JXG.Math.Poly.Monomial</a></b>(ring, coefficient, exponents)
							</div>
							<div class="description">Define a monomial over the polynomial ring <tt>ring</tt>.</div>
						</td>
					</tr>
				</tbody>
			</table>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class JXG.Math.Poly.Monomial.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">JXG.Math.Poly.Monomial.<b><a href="../symbols/JXG.Math.Poly.Monomial.html#.copy">copy</a></b>()
								</div>
								<div class="description">Creates a deep copy of the monomial.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Math.Poly.Monomial.<b><a href="../symbols/JXG.Math.Poly.Monomial.html#.print">print</a></b>()
								</div>
								<div class="description">Print the monomial.</div>
							</td>
						</tr>
...
<!-- ============================== constructor details ==================== -->
			...
			<div class="details"><a name="constructor"> </a>
				...
				<div class="fixedFont">
						<b>JXG.Math.Poly.Monomial</b>(ring, coefficient, exponents)
				</div>
					...
					Define a monomial over the polynomial ring <tt>ring</tt>.
						...
						<dl class="detailList">
							...
							<dt>
    								...
    								<span class="light fixedFont">{Number}</span>  <b>coefficient</b>
							...
							<dt>
    								...
    								<span class="light fixedFont">{Array}</span>  <b>exponents</b>
	    							
                                
                                
							</dt>
								<dd>An array of exponents, corresponding to ring</dd><br /><br />
...
<!-- ============================== method details ========================= -->		
				...
				<div class="sectionTitle">
					...
					<span class="light">{<a href="../symbols/JXG.Math.Poly.Monomial.html">JXG.Math.Poly.Monomial</a>}</span>
					<span class="light">JXG.Math.Poly.Monomial.</span><b>copy</b>()
					...
					<div class="description">
						Creates a deep copy of the monomial.
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{<a href="../symbols/JXG.Math.Poly.Monomial.html">JXG.Math.Poly.Monomial</a>}</span> </dd>
					...
					<span class="light">JXG.Math.Poly.Monomial.</span><b>print</b>()
					...
					<div class="description">
						Print the monomial.
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{String}</span> String representation of the monomial</dd>
