...
<head>
    <meta charset="utf-8">
    <title>JXG.JSXGraph - JSXGraph</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>JXG.JSXGraph Class</h1>

<div class="box meta">


        <div class="foundat">
            Defined in: <a href="../files/src_jsxgraph.js.html#l63"><code>src&#x2F;jsxgraph.js:63</code></a>
        </div>
...
<div class="box intro">
    <p>Constructs a new JSXGraph singleton object.
The JXG.JSXGraph singleton stores all properties required.
to load, save, create and free a board.</p>
