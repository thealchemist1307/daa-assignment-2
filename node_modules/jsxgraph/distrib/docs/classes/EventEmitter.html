...
<head>
    <meta charset="utf-8">
    <title>EventEmitter - JSXGraph</title>
...
<div class="box meta">
        ...
        <div class="foundat">
            Defined in: <a href="../files/src_utils_event.js.html#l49"><code>src&#x2F;utils&#x2F;event.js:49</code></a>
        </div>
        ...
        <div id="index" class="api-class-tabpanel index">
                ...
                <div class="index-section methods">
                    ...
                    <ul class="index-list methods">
                            <li class="index-item method">
                                <a href="#method_eventify">eventify</a>
                ...
                <div class="index-section properties">
                    ...
                    <ul class="index-list properties">
                            <li class="index-item property">
                                <a href="#property_JXG.EventEmitter#eventHandlers">JXG.EventEmitter#eventHandlers</a>

                            </li>
                            <li class="index-item property">
                                <a href="#property_JXG.EventEmitter#suspended">JXG.EventEmitter#suspended</a>
            ...
            <div id="methods" class="api-class-tabpanel">
                <h2 class="off-left">Methods</h2>
                    ...
                    <div id="method_eventify" class="method item">
                        <h3 class="name"><code>eventify</code></h3>
                        ...
                        <div class="meta">
                                    <p>
                                    Defined in
                            <a href="../files/src_utils_event.js.html#l155"><code>src&#x2F;utils&#x2F;event.js:155</code></a>
                            </p>
                        ...
                        <div class="description">
                            <p>Implements the functionality from this interface in the given object. All objects getting their event handling
                    capabilities from this method should document it by adding the <tt>on, off, triggerEventHandlers</tt> via the
                    borrows tag as methods to their documentation: <pre>@borrows JXG.EventEmitter#on as this.on</pre></p>
                    ...
                    <div id="method_off" class="method item">
                        <h3 class="name"><code>off</code></h3>
                            ...
                            <div class="args">
                                <span class="paren">(</span><ul class="args-list inline commas">
                                    ...
                                    <li class="arg">
                                            <code class="optional">[handler]</code>
                                    </li>
                                </ul><span class="paren">)</span>
                            </div>
                        ...
                        <div class="meta">
                                    <p>
                                    Defined in
                            <a href="../files/src_utils_event.js.html#l125"><code>src&#x2F;utils&#x2F;event.js:125</code></a>
                            </p>
                        ...
                        <div class="description">
                            ...
                            <div class="params">
                                ...
                                <ul class="params-list">
                                    ...
                                    <li class="param">
                                            <code class="param-name optional">[handler]</code>
                    ...
                    <div id="method_on" class="method item">
                        ...
                        <div class="meta">
                                    <p>
                                    Defined in
                            <a href="../files/src_utils_event.js.html#l101"><code>src&#x2F;utils&#x2F;event.js:101</code></a>
                            </p>
                        ...
                        <div class="description">
                            <p>Register a new event handler. For a list of possible events see documentation of the elements and objects implementing
                    the <a href="../classes/EventEmitter.html" class="crosslink">EventEmitter</a> interface.</p>
                            ...
                            <div class="params">
                                ...
                                <ul class="params-list">
                                    ...
                                    <li class="param">
                                        ...
                                        <div class="param-description">
                                            <p>The context the handler will be called in, default is the element itself.</p>
                    ...
                    <div id="method_trigger" class="method item">
                        ...
                        <div class="meta">
                                    <p>
                                    Defined in
                            <a href="../files/src_utils_event.js.html#l68"><code>src&#x2F;utils&#x2F;event.js:68</code></a>
                            </p>
                        ...
                        <div class="description">
                            <p>Triggers all event handlers of this element for a given event.</p>
                            ...
                            <div class="params">
                                ...
                                <ul class="params-list">
                                    ...
                                    <li class="param">
                                        ...
                                        <div class="param-description">
                                            <p>The arguments passed onto the event handler</p>
            ...
            <div id="properties" class="api-class-tabpanel">
                <h2 class="off-left">Properties</h2>
                    ...
                    <div id="property_JXG.EventEmitter#eventHandlers" class="property item">
                        <h3 class="name"><code>JXG.EventEmitter#eventHandlers</code></h3>
                        <span class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object" class="crosslink external" target="_blank">Object</a></span>
                        ...
                        <div class="meta">
                                    <p>
                                    Defined in
                            <a href="../files/src_utils_event.js.html#l54"><code>src&#x2F;utils&#x2F;event.js:54</code></a>
                            </p>
                        ...
                        <div class="description">
                            <p>Holds the registered event handlers.</p>
                    ...
                    <div id="property_JXG.EventEmitter#suspended" class="property item">
                        <h3 class="name"><code>JXG.EventEmitter#suspended</code></h3>
                        <span class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object" class="crosslink external" target="_blank">Object</a></span>
                        ...
                        <div class="meta">
                                    <p>
                                    Defined in
                            <a href="../files/src_utils_event.js.html#l61"><code>src&#x2F;utils&#x2F;event.js:61</code></a>
                            </p>
                        ...
                        <div class="description">
                            <p>Events can be suspended to prevent endless loops.</p>
