...
define([
    ...
    JXG.extend(JXG.VMLRenderer.prototype, /** @lends JXG.VMLRenderer */ {
        ...
        updateInternalText: function (el) {
            var v, content = el.plaintext, m = this.joinTransforms(el, el.transformations), offset = [0, 0], maxX, maxY, minX, minY, i, node = el.rendNode, p = [];
        ...
        transformImage: function (el, t) {
            var m, s, maxX, maxY, minX, minY, i, nt, node = el.rendNode, p = [], len = t.length;
            if (len > 0) {
                /*
        ...
        updatePathStringPrim: function (el) {
            var i, scr, pStr = [], r = this.resolution, mround = Math.round, symbm = ' m ', symbl = ' l ', symbc = ' c ', nextSymb = symbm, 
        ...
        updatePathStringBezierPrim: function (el) {
            var i, j, k, scr, lx, ly, pStr = [], f = el.visProp.strokewidth, r = this.resolution, mround = Math.round, symbm = ' m ', symbl = ' c ', nextSymb = symbm, isNoPlot = (el.visProp.curvetype !== 'plot'), len = Math.min(el.numberPoints, 8192); // otherwise IE 7 crashes in hilbert.html
            if (el.numberPoints <= 0) {
                return '';
            }
        ...
        setObjectFillColor: function (el, color, opacity) {
            var rgba = Type.evaluate(color), c, rgbo, o = Type.evaluate(opacity), oo, node = el.rendNode, t;
            o = (o > 0) ? o : 0;
        ...
        setObjectStrokeColor: function (el, color, opacity) {
            var rgba = Type.evaluate(color), c, rgbo, t, o = Type.evaluate(opacity), oo, node = el.rendNode, nodeStroke;
            o = (o > 0) ? o : 0;
        ...
        setObjectStrokeWidth: function (el, width) {
            var w = Type.evaluate(width), node;
