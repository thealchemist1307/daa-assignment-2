...
define([
    ...
    JXG.extend(JXG.SVGRenderer.prototype, /** @lends JXG.SVGRenderer.prototype */ {
        ...
        _createArrowHead: function (element, idAppendix) {
            var node2, node3, id = element.id + 'Triangle', s, d;
        ...
        updateTicks: function (ticks) {
            var i, c, node, x, y, tickStr = '', len = ticks.ticks.length;
            for (i = 0; i < len; i++) {
                c = ticks.ticks[i];
                x = c[0];
                y = c[1];
        ...
        displayCopyright: function (str, fontsize) {
            var node = this.createPrim('text', 'licenseText'), t;
        ...
        transformImage: function (el, t) {
            var s, m, node = el.rendNode, str = "", len = t.length;
            if (len > 0) {
        ...
        updatePathStringBezierPrim: function (el) {
            var i, j, k, scr, lx, ly, len, symbm = ' M ', symbl = ' C ', nextSymb = symbm, maxSize = 5000.0, pStr = '', f = el.visProp.strokewidth, isNoPlot = (el.visProp.curvetype !== 'plot');
            if (el.numberPoints <= 0) {
                return '';
            }
        ...
        setGradient: function (el) {
            var fillNode = el.rendNode, col, op, node, node2, node3, x1, x2, y1, y2;
        ...
        updateGradient: function (el) {
            var col, op, node2 = el.gradNode1, node3 = el.gradNode2;
        ...
        setObjectFillColor: function (el, color, opacity, rendNode) {
            var node, c, rgbo, oo, rgba = Type.evaluate(color), o = Type.evaluate(opacity);
            o = (o > 0) ? o : 0;
        ...
        setObjectStrokeWidth: function (el, width) {
            var node, w = Type.evaluate(width), rgba, c, rgbo, o, oo;
        ...
        dumpToCanvas: function (canvasId) {
            var svgRoot = this.svgRoot, btoa = window.btoa || Base64.encode, svg, tmpImg, cv, ctx;
