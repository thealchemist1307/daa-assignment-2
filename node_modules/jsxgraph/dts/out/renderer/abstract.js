...
define([
    ...
    JXG.extend(JXG.AbstractRenderer.prototype, /** @lends JXG.AbstractRenderer.prototype */ {
        ...
        updateLine: function (element) {
            var s, s1, s2, d, d1x, d1y, d2x, d2y, c1 = new Coords(Const.COORDS_BY_USER, element.point1.coords.usrCoords, element.board), c2 = new Coords(Const.COORDS_BY_USER, element.point2.coords.usrCoords, element.board), minlen = 10, margin = null;
            ...
            */
            ...
            this.updateLinePrim(element.rendNode, c1.scrCoords[1] + d1x, c1.scrCoords[2] + d1y, c2.scrCoords[1] - d2x, c2.scrCoords[2] - d2y, element.board);
        ...
        updateEllipse: function (element) {
            ...
            if (radius > 0.0 &&
                ...
                this.updateEllipsePrim(element.rendNode, element.center.coords.scrCoords[1], element.center.coords.scrCoords[2], (radius * element.board.unitX), (radius * element.board.unitY));
            }
        },
        /* **************************
        ...
        updateTextStyle: function (element, doHighlight) {
            var fs, so, sc, css, node, list, ev = element.visProp, display = Env.isBrowser ? ev.display : 'internal';
            if (doHighlight) {
        ...
        updateImage: function (element) {
            this.updateRectPrim(element.rendNode, element.coords.scrCoords[1], element.coords.scrCoords[2] - element.size[1], element.size[0], element.size[1]);
        ...
        joinTransforms: function (element, transformations) {
            var i, ox = element.board.origin.scrCoords[1], oy = element.board.origin.scrCoords[2], ux = element.board.unitX, uy = element.board.unitY, 
        ...
        setDraft: function (element) {
            ...
            var draftColor = element.board.options.elements.draft.color, draftOpacity = element.board.options.elements.draft.opacity;
        ...
        removeToInsertLater: function (element) {
            var parentNode = element.parentNode, nextSibling = element.nextSibling;
