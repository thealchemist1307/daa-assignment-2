...
define(['jxg', 'utils/type'], function (JXG, Type) {
    ...
    JXG.extend(JXG, /** @lends JXG */ {
        ...
        getCSSTransform: function (cPos, obj) {
            var i, j, str, arrStr, start, len, len2, arr, t = ['transform', 'webkitTransform', 'MozTransform', 'msTransform', 'oTransform'];
        ...
        getCSSTransformMatrix: function (obj) {
            var i, j, str, arrstr, start, len, len2, arr, st, tr, doc = obj.ownerDocument, t = ['transform', 'webkitTransform', 'MozTransform', 'msTransform', 'oTransform'], mat = [[1, 0, 0],
                [0, 1, 0],
                [0, 0, 1]];
