...
(function () {
    ...
    JXG.extend(JXG.GeonextReader.prototype, /** @lends JXG.GeonextReader.prototype */ {
        ...
        colorProperties: function (gxtEl, Data) {
            var rgbo, color = this.gEBTN(Data, 'color', 0, false);
        ...
        readNodes: function (gxtEl, Data, nodeType, prefix) {
            var key, n, arr = this.gEBTN(Data, nodeType, 0, false).childNodes;
            for (n = 0; n < arr.length; n++) {
        ...
        parseImage: function (board, fileNode, level, x, y, w, h, el) {
            var tag, id, picStr, tmpImg, im = null;
            if (fileNode === null) {
                return im;
            }
            // Background image
            ...
            if (picStr !== '') {
                ...
                tmpImg.onload = function () {
                    ...
                    var xf, yf, wf, hf, im, tRot, wOrg = this.width, hOrg = this.height;
        ...
        readNode: function (elChildNodes, s, board) {
            var dataVertex, i, l, x, c, numberDefEls, el, p, inter, rgbo, tmp, v, Data, xmlNode, gxtEl = {};
            Data = elChildNodes[s];
                    ...
                    switch (gxtEl.type) {
                        ...
                        case "210190":
                            ...
                            p = board.create('point', [
                                function () {
                                    var p1 = board.select(gxtEl.defEl[1]), p2 = board.select(gxtEl.defEl[2]);
         ...
         */
        read: function () {
            var xmlNode, elChildNodes, s, boardData, conditions, tmp, tree = this.tree, board = this.board, strTrue = 'true';
        ...
        fixXML: function (str) {
            var arr = ["active", "angle", "animate", "animated", "arc", "area", "arrow", "author", "autodigits", "axis",
                ...
                "yval", "zoom"], list = arr.join('|'), regex = '&lt;(/?(' + list + '))&gt;', expr = new RegExp(regex, 'g');
