...
(function () {
    ...
    JXG.extend(JXG.SketchReader, /** @lends JXG.SketchReader */ {
        ...
        generateJCode: function (step, board, step_log) {
            var i, j, k, sub_id, str, str1, str2, objects, pid1, pid2, pid3, xstart, ystart, el, arr, step2, options, assign, attrid, copy_log = [], set_str = '', reset_str = '', ctx_set_str = '', ctx_reset_str = '', 
