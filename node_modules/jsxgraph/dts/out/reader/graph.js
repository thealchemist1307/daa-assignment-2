...
(function () {
    ...
    JXG.extend(JXG.GraphReader.prototype, /** @lends JXG.GraphReader.prototype */ {
        parseData: function (directed) {
            var splitted, n, nodes = [], adjMatrix = [], i, j, tmp, nodenumbers = {}, tmp2, weighted = false, boundingBox;
        ...
        drawGraph: function (graph) {
            var i, j, s, t, p, x, y, n = graph.n, nodes = graph.nodes, adjMatrix = graph.adjMatrix;
            for (i = 0; i < n; i++) {
