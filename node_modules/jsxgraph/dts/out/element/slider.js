...
define([
    ...
    JXG.createSlider = function (board, parents, attributes) {
        var pos0, pos1, smin, start, smax, sdiff, p1, p2, l1, ticks, ti, startx, starty, p3, l2, t, g, withText, withTicks, snapWidth, attr, precision, el;
        ...
        if (withTicks) {
            ...
            ti = board.create('ticks', [
                ...
                p2.Dist(p1) / ticks,
                function (tick) {
                    var dFull = p1.Dist(p2), d = p1.coords.distance(Const.COORDS_BY_USER, tick);
                    if (dFull < Mat.eps) {
                        return 0;
                    }
