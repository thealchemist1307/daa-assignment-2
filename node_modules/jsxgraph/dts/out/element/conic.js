...
define([
    ...
    JXG.createEllipse = function (board, parents, attributes) {
        var polarForm, curve, M, C, majorAxis, i, hasPointOrg, 
        // focus 1 and focus 2
        F = [], attr_foci = Type.copyAttributes(attributes, board.options, 'conic', 'foci'), attr_curve = Type.copyAttributes(attributes, board.options, 'conic');
    ...
    JXG.createParabola = function (board, parents, attributes) {
        ...
        F1 = parents[0], 
        // directrix
        l = parents[1], attr_foci = Type.copyAttributes(attributes, board.options, 'conic', 'foci'), attr_curve = Type.copyAttributes(attributes, board.options, 'conic');
        ...
        /** @ignore */
        curve.X = function (phi, suspendUpdate) {
            var a, det, beta = l.getAngle(), d = Geometry.distPointLine(F1.coords.usrCoords, l.stdform), A = l.point1.coords.usrCoords, B = l.point2.coords.usrCoords, M = F1.coords.usrCoords;
    ...
    JXG.createConic = function (board, parents, attributes) {
        var polarForm, curve, fitConic, degconic, sym, eigen, a, b, c, c1, c2, i, definingMat, givenByPoints, rotationMatrix = [
            ...
            [0, 1, 0],
            [0, 0, 1]
        ], points = [], p = [], attr_foci = Type.copyAttributes(attributes, board.options, 'conic', 'foci'), attr_curve = Type.copyAttributes(attributes, board.options, 'conic');
        if (parents.length === 5) {
            givenByPoints = true;
        }
