...
define([
    ...
    JXG.extend(JXG.Line.prototype, /** @lends JXG.Line.prototype */ {
        ...
        hasPoint: function (x, y) {
            ...
            var c = [], s, v = [1, x, y], vnew, p1c, p2c, d, pos, i;
            c[0] = this.stdform[0] -
        ...
        getLabelAnchor: function () {
            var x, y, fs = 0, c1 = new Coords(Const.COORDS_BY_USER, this.point1.coords.usrCoords, this.board), c2 = new Coords(Const.COORDS_BY_USER, this.point2.coords.usrCoords, this.board);
            if (this.visProp.straightfirst || this.visProp.straightlast) {
    ...
    JXG.createLine = function (board, parents, attributes) {
        var ps, el, p1, p2, i, attr, c = [], constrained = false, isDraggable;
        /**
