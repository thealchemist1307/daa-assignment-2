...
define([
    ...
    JXG.Polygon = function (board, vertices, attributes) {
        ...
        var i, vertex, l, len, j, attr_line = Type.copyAttributes(attributes, board.options, 'polygon', 'borders');
    ...
    JXG.extend(JXG.Polygon.prototype, /** @lends JXG.Polygon.prototype */ {
        ...
        boundingBox: function () {
            var box = [0, 0, 0, 0], i, v, le = this.vertices.length - 1;
            if (le === 0) {
                return box;
            }
        ...
        removePoints: function (p) {
            var i, j, idx, nvertices = [], nborders = [], nidx = [], partition = [];
            // partition:
        ...
        */
        sutherlandHodgman: function (polygon) {
            ...
            lenClip = clip.length - 1, lenSubject = subject.length - 1, lenIn, outputList = [], inputList, i, j, S, E, cross, 
