...
define([
    ...
    JXG.extend(JXG.CoordsElement.prototype, /** @lends JXG.CoordsElement.prototype */ {
        ...
        updateGlider: function () {
            var i, p1c, p2c, d, v, poly, cc, pos, sgn, alpha, beta, delta = 2.0 * Math.PI, angle, cp, c, invMat, newCoords, newPos, doRound = false, slide = this.slideObject;
        ...
        updateGliderFromParent: function () {
            var p1c, p2c, r, lbda, c, slide = this.slideObject, baseangle, alpha, angle, beta, delta = 2.0 * Math.PI, newPos;
        ...
        handleSnapToPoints: function (force) {
            var i, pEl, pCoords, d = 0, len, dMax = Infinity, c = null, len2, j, ignore = false;
        ...
        handleAttractors: function () {
            var i, el, projCoords, d = 0.0, projection, len = this.visProp.attractors.length;
        ...
        setPositionDirectly: function (method, coords) {
            var i, c, dc, oldCoords = this.coords, newCoords;
        ...
        makeGlider: function (slide) {
            var slideobj = this.board.select(slide), onPolygon = false, min, i, dist;
        ...
        addConstraint: function (terms) {
            var fs, i, v, t, newfuncs = [], what = ['X', 'Y'], makeConstFunction = function (z) {
                return function () {
                    return z;
                };
        ...
        _anim: function (direction, stepCount) {
            var distance, slope, dX, dY, alpha, startPoint, newX, radius, factor = 1;
