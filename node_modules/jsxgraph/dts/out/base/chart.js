...
define([
...
], function (JXG, Numerics, Statistics, Const, Coords, GeometryElement, DataSource, Color, Type, Env, Curve, Point, Text, Polygon, Sector, Transform, Line, Circle) {
    "use strict";
    /**
     * Chart plotting
     */
    ...
    JXG.extend(JXG.Chart.prototype, /** @lends JXG.Chart.prototype */ {
        ...
        drawBar: function (board, x, y, attributes) {
            var i, strwidth, fill, fs, text, w, xp0, xp1, xp2, yp, colors, pols = [], p = [], attr, makeXpFun = function (i, f) {
                return function () {
                    return x[i]() - f * w;
                };
            }, hiddenPoint = {
        ...
        drawPie: function (board, y, attributes) {
            var i, center, p = [], sector = [], s = Statistics.sum(y), colorArray = attributes.colors, highlightColorArray = attributes.highlightcolors, labelArray = attributes.labels, r = attributes.radius || 4, radius = r, cent = attributes.center || [0, 0], xc = cent[0], yc = cent[1], makeRadPointFun = function (j, fun, xc) {
                return function () {
                    var s, t = 0, i, rad;
                    for (i = 0; i <= j; i++) {
    ...
    JXG.createChart = function (board, parents, attributes) {
        var data, row, i, j, col, charts = [], w, x, showRows, attr, originalWidth, name, strokeColor, fillColor, hStrokeColor, hFillColor, len, table = Env.isBrowser ? board.document.getElementById(parents[0]) : null;
    ...
    JXG.Legend.prototype.drawVerticalLegend = function (board, attributes) {
        ...
        for (i = 0; i < this.label_array.length; i++) {
            ...
            this.lines[i] = board.create('line', [
                ...
                [this.coords.usrCoords[1] + line_length, this.coords.usrCoords[2] - i * offy]], this.myAtts);
