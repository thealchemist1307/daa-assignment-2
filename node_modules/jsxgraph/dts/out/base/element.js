...
define([
    ...
    JXG.extend(JXG.GeometryElement.prototype, /** @lends JXG.GeometryElement.prototype */ {
        ...
        setPositionDirectly: function (method, coords, oldcoords) {
            var c = new Coords(method, coords, this.board, false), oldc = new Coords(method, oldcoords, this.board, false), dc = Statistics.subtract(c.usrCoords, oldc.usrCoords);
        ...
        setAttribute: function (attributes) {
            var i, key, value, arg, opacity, pair, oldvalue, properties = {};
        ...
        handleSnapToGrid: function (force, fromParent) {
            var x, y, ticks, 
            //i, len, g, el, p,
            boardBB, needsSnapToGrid = false, sX = this.visProp.snapsizex, sY = this.visProp.snapsizey;
