...
define([
    ...
    JXG.extend(JXG.Circle.prototype, /** @lends JXG.Circle.prototype */ {
        ...
        hasPoint: function (x, y) {
            var prec = this.board.options.precision.hasPoint / (this.board.unitX), mp = this.center.coords.usrCoords, p = new Coords(Const.COORDS_BY_SCREEN, [x, y], this.board), r = this.Radius(), dist = Math.sqrt((mp[1] - p.usrCoords[1]) * (mp[1] - p.usrCoords[1]) + (mp[2] - p.usrCoords[2]) * (mp[2] - p.usrCoords[2]));
        ...
        updateStdform: function () {
            ...
            if (!isFinite(this.stdform[4])) {
                this.stdform[0] = Type.exists(this.point2) ? -(this.stdform[1] * this.point2.coords.usrCoords[1] +
        ...
        getLabelAnchor: function () {
            var x, y, r = this.Radius(), c = this.center.coords.usrCoords;
