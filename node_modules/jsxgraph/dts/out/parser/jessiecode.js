...
define([
    ...
    JXG.extend(JXG.JessieCode.prototype, /** @lends JXG.JessieCode.prototype */ {
        ...
        createReplacementNode: function (node) {
            ...
            node = this.createNode('node_op', 'op_execfun', this.createNode('node_var', '$'), [this.createNode('node_str', el.id)]);
            node.replaced = true;
            return node;
        },
        /**
        ...
        execute: function (node) {
            var ret, v, i, e, l, undef, list, ilist, parents = [], 
            // exec fun
            fun, attr, sc;
            ret = 0;
            if (!node) {
            ...
            performAction: function anonymous(yytext, yyleng, yylineno, yy, yystate /* action[1] */, $$ /* vstack */, _$ /* lstack */) {
                ...
                switch (yystate) {
                    ...
                    case 31:
                        ...
                        break;
                    case 33:
                        this.$ = AST.createNode(lc(_$[$0 - 2]), 'node_op', 'op_equ', $$[$0 - 2], $$[$0]);
                        this.$.isMath = false;
                        break;
                    case 34:
                    ...
                    case 35:
                        ...
                        break;
                    case 37:
                        this.$ = AST.createNode(lc(_$[$0 - 2]), 'node_op', 'op_lot', $$[$0 - 2], $$[$0]);
                        this.$.isMath = false;
                        break;
                    case 38:
                        this.$ = AST.createNode(lc(_$[$0 - 2]), 'node_op', 'op_grt', $$[$0 - 2], $$[$0]);
                        this.$.isMath = false;
                        break;
                    case 39:
                        this.$ = AST.createNode(lc(_$[$0 - 2]), 'node_op', 'op_loe', $$[$0 - 2], $$[$0]);
                        this.$.isMath = false;
                        break;
                    case 40:
                        this.$ = AST.createNode(lc(_$[$0 - 2]), 'node_op', 'op_gre', $$[$0 - 2], $$[$0]);
                        this.$.isMath = false;
                        break;
                    case 42:
